  ...
  return (
    ...
    <div className="app-container">
      <Nevbar/>
       ...
       {(sessionStorage.getItem("TeachersLogin")||teacherslogin===true)?<> <Route path="/TeachersProfile" element={<TeachersProfile/>} /> </> :<Route path="/login" element={ <LoginSection/>}>     </Route> }  
