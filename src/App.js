    ...
    <Routes>
      {sessionStorage.getItem("StudentsID") || login === true ? (
        <>
          ...
          <Route path="/login" element={<StudentsProfile />} />
        </>
      ) : (
        <>
          <Route path="/StudentsProfile" element={<LoginSection />} />
        
        </>
      )}

      {sessionStorage.getItem("DepartmentLogin") || Adminlogin === true ? (
        <>
          <Route path="/ViewProfile/:id" element={<ViewTeachersProfile />} />
          <Route path="/RegistrationForm" element={<Registration />} />
          <Route path="/CourseAdd" element={<AddCourse />} />
          <Route path="/CourseList" element={<CourseList />} />
          <Route path="/DepartmentCSE" element={<DepartmentProfile />} />
          <Route path="/CourseList/:id" element={<Edit />} />
          <Route path="/DeleteteachersProfile/:id" element={<DeleteProfile />} />
          <Route path="/AssignCourse" element={<AssignCourse />} />
          <Route path="/DeleteCourse/:id" element={<DeleteCourse />} />
          <Route path="/EditTeachersProfile/:id" element={<EditTeachersProfile />} />
          <Route path="/login" element={<DepartmentProfile />} />
        </>
      ) : (
       <>
       <Route path="/DepartmentCSE" element={<LoginSection />}>  </Route>
       </> 
      ...
      {sessionStorage.getItem("TeachersLogin") || teacherslogin === true ? (
        <>
          ...
          <Route path="/publisedResult/:course" element={<PublisedNumber />} />
          <Route path="/viewstudentsList/:id/:course/:credit" element={<CourseStudentsList />} />
          <Route path="/AddNumber/:course/:id/:semester/:name/:registation/:credit" element={<AddNumber />} />
          <Route path="/TeachersProfile" element={<TeachersProfile />} />
          <Route path="/login" element={<TeachersProfile />} />
        </>
      ) : (
        <>
       
          <Route path="/TeachersProfile" element={<LoginSection />} />
        </>
      )}

      {sessionStorage.getItem("ExamControler") || Controler === true ? (
        <>
          <Route path="viewResult/:semester/:roll" element={<ViewResult />} />
          <Route path="/ControlerProfile" element={<ExamController />} />
          <Route path="/login" element={<ExamController />} />
        </>
      ) : (
        <>
         
          <Route path="/ControlerProfile" element={<LoginSection />} />
        </>
      )}
