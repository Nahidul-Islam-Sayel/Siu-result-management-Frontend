...
function App() {
  ...
  return (
    <userContext.Provider value={[login,setLogin,Adminlogin,setAdminlogin,AssignTechers,setAssignTechers,CourseName,setCourseName,teacherslogin,setTeacherslogin]}>
    <BrowserRouter>
    <div className="app-container">
      <Nevbar/>
       ...
       {(sessionStorage.getItem("TeachersLogin")||teacherslogin===true)?<>  <Route path="/EditNumber/:id" element={<EditNumber/> }/> <Route path="/publisedResult/:course" element={<PublisedNumber/> }/> <Route path="/viewstudentsList/:id/:course" element={<CourseStudentsList/> }/>  <Route path="/AddNumber/:course/:id/:semester/:name/:registation" element={<AddNumber/> }/>  <Route path="/TeachersProfile" element={<TeachersProfile/>} /> </> :<Route path="/login" element={ <LoginSection/>}>     </Route> }  
